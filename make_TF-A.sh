...
if [ $1 == "astro" ]; then
    ...
    mkdir -p ../../image
    cp ./build/stm32mp1/debug/tf-a-stm32mp157c-astro.stm32 ../../image/
    cp ./build/stm32mp1/debug/bl32.bin ../../image/
    cp ./build/stm32mp1/debug/fdts/stm32mp157c-astro-fw-config.dtb ../../image/
    cp ./build/stm32mp1/debug/fdts/stm32mp157c-astro-bl32.dtb ../../image/
