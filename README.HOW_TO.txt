...
In the TF-A source directory (sources/*/tf-a-stm32mp-v2.6-stm32mp-r2-r0),
you have one TF-A source tarball, the patches and one Makefile:
   - tf-a-stm32mp-v2.6-stm32mp-r2-r0.tar.xz
   - 00*.patch
   - Makefile.sdk
